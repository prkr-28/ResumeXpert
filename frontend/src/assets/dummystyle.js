...
export const dashboardStyles = {
   // Container
   container: 'container mx-auto px-4 sm:px-6 lg:px-8 py-6',

   // Header
   headerWrapper:
      // mobile: center content | desktop: space-between
      'flex flex-col md:flex-row justify-center md:justify-between items-center gap-4 mb-6',
   headerTitle:
      'text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 text-center md:text-left',
   headerSubtitle:
      'text-gray-600 text-sm sm:text-base text-center md:text-left',

   // Create Button (top one after navbar)
   createButton:
      'group relative px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-violet-200',
   createButtonOverlay:
      'absolute inset-0 bg-gradient-to-r from-fuchsia-600 to-orange-500 opacity-0 group-hover:opacity-100 transition-opacity',
   createButtonContent:
      'relative flex items-center justify-center gap-2 sm:gap-3 text-center',

   // Loading
   spinnerWrapper: 'flex justify-center items-center py-12',
   spinner:
      'animate-spin rounded-full h-10 w-10 sm:h-12 sm:w-12 border-t-2 border-b-2 border-violet-600',

   // Empty State
   emptyStateWrapper:
      'flex flex-col items-center justify-center py-10 px-4 text-center max-w-lg mx-auto',
   emptyIconWrapper: 'bg-violet-100 p-4 rounded-full mb-4',
   emptyTitle: 'text-lg sm:text-xl font-bold text-gray-900 mb-2',
   emptyText: 'text-gray-600 text-sm sm:text-base mb-6',

   // Grid - center single items on mobile
   grid: 'flex flex-wrap justify-center gap-6 sm:grid sm:grid-cols-2 xl:grid-cols-3',

   // New Resume Card
   newResumeCard:
      'flex flex-col items-center justify-center bg-gradient-to-br from-violet-50 to-blue-50 border-2 border-dashed border-violet-300 rounded-2xl p-6 sm:p-8 cursor-pointer transition-all hover:shadow-lg hover:border-violet-500 min-h-[220px] text-center',
   newResumeIcon:
      'w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gradient-to-r from-violet-600 to-fuchsia-600 flex items-center justify-center mb-4',
   newResumeTitle:
      'text-lg sm:text-xl font-bold text-gray-900 mb-1 text-center',
   newResumeText: 'text-gray-600 text-sm text-center',

   // Modal
   modalHeader: 'flex justify-between items-center mb-4',
   modalTitle: 'text-lg sm:text-xl font-bold text-gray-900',
   modalCloseButton: 'text-gray-500 hover:text-gray-700',

   // Delete Confirmation
   deleteIconWrapper:
      'bg-red-100 p-3 rounded-full mb-4 flex items-center justify-center',
   deleteTitle: 'text-base sm:text-lg font-bold text-gray-900 mb-2',
   deleteText: 'text-gray-600 text-sm sm:text-base mb-4',
};
...
export const cardStyles = {
   ...
   // ProfileInfoCard styles
   profileCard:
      'flex items-center gap-3 px-3 py-2 sm:px-4 sm:py-2 bg-white/90 backdrop-blur-lg border border-gray-200 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 hover:scale-[1.03] absolute right-4 md:right-14 top-1/2 -translate-y-1/2',
   profileInitialsContainer:
      'w-6 h-6 sm:w-12 sm:h-12 bg-gradient-to-br from-violet-500 to-fuchsia-500 rounded-full flex items-center justify-center shadow-md',
   profileInitialsText: 'text-base sm:text-lg font-black text-white',
   profileName: 'text-xs sm:text-[18px] font-bold text-gray-800',
   logoutButton:
      'text-violet-600 text-[10px] sm:text-sm font-bold border-b border-b-fuchsia-600 cursor-pointer hover:text-fuchsia-600 transition-colors',
...
export const containerStyles = {
   ...
   header:
      'flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 bg-gradient-to-r from-white to-violet-50 border border-violet-100 rounded-2xl py-4 px-4 sm:px-6 mb-6 shadow-sm',
...
export const modalStyles = {
   ...
   actionButton:
      'flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white font-bold rounded-xl hover:scale-105 transition-all shadow-lg mr-12',
   closeButton:
      'absolute top-4 right-4 w-8 h-8 flex items-center justify-center bg-white/80 hover:bg-red-50 text-slate-400 hover:text-red-500 rounded-xl transition-all shadow-lg hover:scale-110 z-10',
